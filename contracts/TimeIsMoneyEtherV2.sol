...
import "./interfaces/TimeIsMoneyEtherIV2.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";

contract TimeIsMoneyEtherV2 is TimeIsMoneyEtherIV2, ReentrancyGuard {
     ...
     */
    function lock(address to) public override payable nonReentrant {
        ...
        require(lockAmount[to] == 0, "You have already participated in this.");
        ...
        totalLocked += amount;
        releaseTime[to] = block.timestamp + minimumLockTime;
